...
class Form2 extends React.Component {
  ...
  handleFormSubmit(e) {
    ...
    //calculate LBM
    data[1].value =
      (this.state.input[2].value * (100 - this.state.input[1].value)) / 100;
    this.setState({ data });
        ...
        <Grid item xs={12} sm={6} align="center">
          <Paper className={classes.paper}>
            ...
            <FormControl
              ...
              aria-describedby="bodyfat-helper-text"
            >
              <Input
                placeholder="20"
                type="number"
              ...
              />
              <FormHelperText id="weight-helper-text">Body Fat</FormHelperText>
            </FormControl>
          </Paper>
        </Grid>
